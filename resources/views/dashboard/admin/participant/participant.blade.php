                    ...
                    <form method="GET" class="mb-3">
                        <div class="d-flex justify-content-end">
                            <div class="input-group flex-nowrap w-50 w-md-50 w-lg-25 ms-auto">
                                <input type="text" name="search" class="form-control" placeholder="Search participants..."
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('participants.show', $participant->participant_id) }}" class="btn btn-link btn-info btn-lg" data-bs-toggle="tooltip" title="View Participant Details">
                                                        <i class="fa fa-eye"></i>
                                                    </a>

                                                    <button type="button" class="btn btn-link btn-primary btn-lg" data-bs-toggle="tooltip" title="Edit Participant">
                                                        <a href="{{ route('participants.edit', $participant->participant_id) }}" class="text-decoration-none text-primary">
