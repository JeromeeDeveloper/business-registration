                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card shadow-sm p-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="no_of_entitled_votes">Complied SC Req. / # Voting Delegate</label>
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="card shadow-sm p-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="cetf_due_to_apex"
                                                            id="cetf_due_to_apex" value="{{ $coop->cetf_due_to_apex }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            id="cetf_undertaking" value="{{ $coop->cetf_undertaking }}"
                                            ...
                                            <!-- Third Column: Registration Fee -->
                                            <!-- Third Column: Registration Fee Calculation -->
                                            <div class="col-md-6 col-lg-4">
                                                <div class="card shadow-sm p-3">
                                                    <h5 class="text-primary">Registration Fee: PHP 1000, 4500, and 5500
                                                    </h5>
                                                    <hr>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            ...
                                                            placeholder="Enter Net Required RegFee">
                                                    </div>
