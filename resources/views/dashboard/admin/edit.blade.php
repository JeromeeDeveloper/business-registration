                                                ...
                                                <div class="col-md-6 col-lg-4">
                                                    <div class="card shadow-sm p-3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="delinquent_display"
                                                                disabled>
                                                                <option value="yes"
