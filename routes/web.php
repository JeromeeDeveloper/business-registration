...
Route::middleware([AdminOrSupportMiddleware::class])->group(function () {
    ...
    Route::get('/admin/reports/officers', [ReportsController::class, 'officers'])
...
Route::middleware([AdminMiddleware::class])->group(function () {
    ...
    Route::get('/generate-pdf-single/{cooperative_id}', [ReportsController::class, 'printSingleCoopSummary'])->name('admin.generatePDFsingle');
